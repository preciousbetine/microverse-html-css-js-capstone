...
<div align="center">
  ...
  <h4>Emerging Tech Conference Page</h4>
...
- An Homepage - Showing the event name, partners, and featured speakers.
- An About page listing past events and other information.
- A mobile menu.
...
```sh
cd my-folder
git clone https://github.com/preciousbetine/microverse-html-css-js-capstone.git
```
...
### Deployment <a name="triangular_flag_on_post-deployment"></a>
  This website is live at [this link](https://preciousbetine.github.io/microverse-html-css-js-capstone)
